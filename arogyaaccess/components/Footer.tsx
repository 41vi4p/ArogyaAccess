...
export default function Footer() {
  return (
    <footer className="bg-gray-900 dark:bg-black text-white pt-12 pb-6 transition-colors">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Bottom Bar */}
        <div className="border-t border-gray-800 dark:border-gray-900 pt-6 text-center text-gray-400 dark:text-gray-500 text-sm">
