    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-cyan-50">
      ...
      <section className="bg-gradient-to-br from-cyan-500 to-blue-600 text-white py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6">About ArogyaAccess</h1>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg text-center">
              ...
              <p className="text-gray-600">Building confidence through reliable medical guidance</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-lg text-center">
              <div className="bg-cyan-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">Supporting multiple languages and all communities</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-lg text-center">
              <div className="bg-cyan-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">Providing the highest quality medical assistance</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">First Aid Guide</h3>
                <p className="text-gray-600">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Patient-Doctor Network</h3>
                <p className="text-gray-600">
      ...
      <section className="py-20 bg-gradient-to-br from-cyan-500 to-blue-600 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Team CodeBreakers</h2>
          <p className="text-xl text-cyan-50 max-w-3xl mx-auto mb-8">
